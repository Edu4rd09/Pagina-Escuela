...
window.addEventListener('scroll', function() {
        ...
        if(window.scrollY<=1){
                ...
                for (let i = 0; i < Titulo.length; i++) {
                        Titulo[i].style.color = 'rgb(255, 255, 255)';
                        Titulo[i].style.fontSize = 100+'%';
                }
                for (let i = 0; i < liks.length; i++) {
                        liks[i].style.color = 'rgb(255, 255, 255)';
                }
                ...
                for (let i = 0; i < Titulo.length; i++) {
                        Titulo[i].style.color = 'rgb(0, 0, 0)';
                        Titulo[i].style.fontSize = 70+'%';
                }
                for (let i = 0; i < liks.length; i++) {
                        liks[i].style.color = 'rgb(0, 0, 0)';
                }
